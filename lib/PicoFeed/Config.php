 ...
 * @method  \PicoFeed\Config setContentFilteringCallback(\Closure $callback)
 ...
 * @method  \Closure   getContentFilteringCallback()
 * @method  string     getTimezone()
 * @method  array      getFilterIframeWhitelist()
 * @method  array      getFilterIntegerAttributes()
 * @method  array      getFilterAttributeOverrides()
 * @method  array      getFilterRequiredAttributes()
 * @method  array      getFilterMediaBlacklist()
 * @method  array      getFilterMediaAttributes()
 * @method  array      getFilterSchemeWhitelist()
 * @method  array      getFilterWhitelistedTags()
 * @method  array      getFilterBlacklistedTags()
 */
class Config
{
    /**
